                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center mb-8 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    <div className="w-16 h-16 bg-gradient-to-br from-[#2563eb] to-[#1d4ed8] rounded-lg flex items-center justify-center text-white font-bold text-lg mr-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center mt-1">
                                            <span className={`inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-[#2563eb]/10 text-[#2563eb] border border-[#2563eb]/20`}>
                                                <BadgeCheck className="w-3 h-3 mr-1" />
                                                {roleInfo.label}
                                            </span>
                                            {user?.is_verified && (
                                                <span className="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-[#2563eb]/10 text-[#2563eb] border border-[#2563eb]/20 ml-2">
                                ...
                                <div className="mt-8 p-4 bg-[#2563eb]/10 rounded-lg border border-[#2563eb]/20">
                                    <h4 className="text-sm font-semibold text-[#2563eb] mb-2 flex items-center">
                                        <Shield className="w-4 h-4 mr-2" />
                                        Informations système (non modifiables)
                                    </h4>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                        <div>
                                            <span className="text-[#2563eb] font-medium">Rôle :</span>
                                            <span className="ml-2 text-blue-800 dark:text-blue-300 font-semibold">{roleInfo.label}</span>
                                        </div>
                                        <div>
                                            <span className="text-[#2563eb] font-medium">Statut vérification :</span>
                                            <span className={`ml-2 font-semibold ${user?.is_verified ? 'text-[#2563eb]' : 'text-yellow-600 dark:text-yellow-400'}`}>
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between pt-6 mt-8 border-t border-gray-200 dark:border-gray-700">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <button
                                            type="submit"
                                            disabled={saving}
                                            className="inline-flex items-center px-6 py-3 bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-medium hover:shadow-md transition-all duration-200 disabled:opacity-50 rounded-lg"
                                        >
                                            {saving ? (
                                                <>
                        ...
                        >
                            ...
                            <div className="p-4 space-y-3">
                                <div className="flex items-start">
                                    <CheckCircle className="w-4 h-4 text-[#2563eb] mr-3 mt-1 flex-shrink-0" />
                                ...
                                <div className="flex items-start">
                                    <CheckCircle className="w-4 h-4 text-[#2563eb] mr-3 mt-1 flex-shrink-0" />
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        En tant qu'Employé, vos informations sont nécessaires au bon fonctionnement des services RH.
                                    </p>
                                </div>
                            </div>
                        </motion.div>
