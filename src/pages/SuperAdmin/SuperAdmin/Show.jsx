    ...
    <SuperAdminLayout>
      ...
      >
        <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 mb-4">
          ...
          <span>›</span>
          <Link to="/superadmin/super-admins" className="hover:text-[#179150] transition-colors">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div className="mb-4 lg:mb-0">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Détails du compte super administrateur 
            </p>
          </div>
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className="flex items-center px-4 py-2 bg-red-600 text-white font-medium hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-colors rounded-lg"
            >
            ...
            <div className="p-6">
              <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8 mb-8">
                <div className="relative">
                  <div className="w-24 h-24 bg-gradient-to-br from-[#179150] to-[#147a43] flex items-center justify-center text-white font-bold text-xl rounded-lg">
                    {getInitials(admin.first_name, admin.last_name)}
                  </div>
                  <div className="absolute -bottom-2 -right-2 bg-[#179150] text-white p-2 border-2 border-white dark:border-gray-800 rounded-lg">
          ...
          >
            ...
            <div className="p-4 space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-700">
                ...
                <span className="text-sm font-medium text-[#179150]">Super Administrateur</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-700">
