...
export default function AdminList() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      showToastMessage('Supers Administrateur supprimé avec succès', 'success');
      fetchAdmins();
    } catch (error) {
  ...
  const exportToCSV = () => {
    ...
    link.href = url;
    link.download = 'supers_administrateurs.csv';
    link.click();
    ...
    <SuperAdminLayout>
      ...
      >
        <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 mb-4">
          ...
          <span>›</span>
          <span className="text-gray-900 dark:text-white">Supers Administrateurs</span>
        </nav>
            ...
            <div className="flex items-center mb-3">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Gestion des comptes supers administrateurs
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                onClick={exportToCSV}
                className="flex items-center px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors rounded-lg"
              >
              ...
              {filteredAdmins.map((admin, index) => (
                ...
                >
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="w-10 h-10 bg-gradient-to-br from-[#179150] to-[#147a43] rounded-lg flex items-center justify-center text-white font-semibold text-sm mr-4">
        ...
        {filteredAdmins.length === 0 && (
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
              {searchTerm || statusFilter ? 'Aucun résultat' : 'Aucun supers administrateur'}
            </h3>
            <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-md mx-auto">
              {searchTerm || statusFilter 
                ? "Aucun supers administrateur ne correspond à vos critères de recherche." 
                : "Commencez par créer votre premier supers administrateur."
              }
            </p>
            {!searchTerm && !statusFilter && (
              <Link
