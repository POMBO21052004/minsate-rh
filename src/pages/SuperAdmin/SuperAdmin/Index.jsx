        ...
        {filteredAdmins.length === 0 && (
          ...
          >
            ...
            <h5 className="text-gray-600 dark:text-gray-400 text-lg font-semibold mb-4">
              {hasActiveFilters ? 'Aucun administrateur système trouvé' : 'Aucun administrateur système'}
            </h5>
            ...
            >
              ...
              <div className="p-6">
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  Êtes-vous sûr de vouloir supprimer les <strong className="text-red-600">{selectedAdmins.size} administrateur(s) système</strong> sélectionné(s) ?
                </p>
        ...
        {showActivateGroupModal && (
          ...
          >
            ...
            >
              ...
              <div className="p-6">
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  Êtes-vous sûr de vouloir activer les <strong className="text-green-600">{selectedAdmins.size} administrateur(s) système</strong> sélectionné(s) ?
                </p>
        ...
        {showDeactivateGroupModal && (
          ...
          >
            ...
            >
              ...
              <div className="p-6">
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  Êtes-vous sûr de vouloir désactiver les <strong className="text-yellow-600">{selectedAdmins.size} administrateur(s) système</strong> sélectionné(s) ?
                </p>
                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 p-4 mb-4 rounded-lg">
                  <div className="flex items-start">
                    <AlertCircle className="w-4 h-4 text-yellow-600 mr-2 mt-0.5 flex-shrink-0" />
